...
VALUES
  ('a1b2c3d4-1111-1111-1111-000000000001', 'Thesis Draft', 'My master thesis on distributed systems', 'latex', 'pdflatex', '3.14', 'pdf', 'user-001'),
  ('a1b2c3d4-1111-1111-1111-000000000002', 'Meeting Notes', 'Weekly team sync notes', 'markdown', 'pandoc', '2.19', 'html', 'user-002'),
  ('a1b2c3d4-1111-1111-1111-000000000003', 'Invoice Template', 'Standard invoice layout', 'typst', 'typst', '0.11', 'pdf', 'user-001');
